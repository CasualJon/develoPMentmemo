...
var dmIndx = [
  ...
  },
  {
    ...
    category: memoGroup.PSYCHOLOGY,
    keywords: "SELECTIVE ATTENTION LIMITED RESOURCE GORILLA",
    path: "./assets/js/dm111.js",
  },
  {
    num: 112,
    title: "Don't be a Jerk (100LL)",
    category: memoGroup.COMMUNICATION,
    keywords: "BASTARDS GENTLEMEN LADIES LOST SOULS PROCRASTINATORS WHISY-WASHERS STRONG WILL RESPECT ARM RESIDUE BUDGETARY RISK AMONG PROJECTS PMI DON'T BE A JERK 100LL LESSONS LEARNED",
    path: "./assets/js/dm112.js",
  },
  {
    num: 113,
    title: "For Want of a Nail the Race was Lost (100LL)",
    category: memoGroup.QUALITY,
    keywords: "FOR WANT OF NAIL THE RACE WAS LOST HORSESHOE RIDER MESSAGE BATTLE 100LL LESSONS LEARNED",
    path: "./assets/js/dm113.js",
  },
  {
    num: 114,
    title: "NASA SEL Dos and Don'ts for Software Success",
    category: memoGroup.PSYCHOLOGY,
    keywords: "NASA SEL SOFTWARE ENGINEERING LABRATORY CHECKLIST SOFTWARE PROJECT SURVIVAL GUIDE STEVE MCCONNELL",
    path: "./assets/js/dm114.js",
  },
  {
    num: 115,
    title: "The Top 2% of PMs: Skills and Characteristics",
    category: memoGroup.PM_BASICS,
    keywords: "TOP 2% TWO PERCENT OF PMS ANDY CROWE CASE STUDY ALPHA PROJECT MANAGERS FEEDBACK",
    path: "./assets/js/dm115.js",
  },
  {
    num: 116,
    title: "Positive, Prosocial Behavior Boosts Trust",
    category: memoGroup.PEOPLE,
    keywords: "TRUST POSITIVE PROSOCIAL BEHAVIOR BOOSTS AFFECTIVE BALANCE EFFICACY SMILE ANSWERING PHOINE MOOD CONTAGIOUS RECOGNIZE CONTRATULATE SUCCESSES HIGH PERFORMING TEAMS",
    path: "./assets/js/dm116.js",
  },
];
