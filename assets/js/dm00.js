...
memoString += "<h5>This is more work.  I thought it would be easier.</h5>";
...
memoString += "But, being appointed a lead grants no wisdom.  Getting introduced by the honorific brings no insight.  Offering opinion for recognition’s sake builds no understanding.<br /><br />";
...
function getMemo() = {
  ...
  //var subPage = document.getElementById('randomMemo');
