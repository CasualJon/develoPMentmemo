...
memoString += "<p><span id=\"preamble\"><i>Projectizing a matrixed functional organization</i> is a phrase that just might win you buzzword bingo on a conference call.<br />";
memoString += "This is assuming, of course, that you remain conscious after the whopper of a facepalm you’d give yourself upon hearing it…</span></p><br />";
...
memoString += "<ul><li><b>Functional Organization:</b> This is the traditional way of organizing a business, functional organizations split their structure by its various functions (HR, Marketing, IT...)</li><br />";
memoString += "<li><b>Projectized Organization:</b> In this structure, each project manager reports directly into the CEO. Each project manager will have their own full-time team members and staff. This will only suit an organization where projects and their delivery are the core business</li><br />";
